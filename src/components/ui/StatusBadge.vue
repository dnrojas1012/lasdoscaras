...
.badge--danger { background: color-mix(in srgb, var(--color-error) 18%, transparent); color: var(--color-error); }
.badge--warning { background: color-mix(in srgb, var(--color-warning) 30%, transparent); color: #7a5b00; }
