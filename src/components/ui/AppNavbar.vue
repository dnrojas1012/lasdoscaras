...
watch(terminoDebounced, (valor) => {
  // Menos de 2 caracteres no dispara busqueda: evita mandar la
  // consulta al escribir una sola letra.
...
function cerrarSesion(): void {
  auth.logout()
  // Los favoritos son del usuario que se va, no deben quedar visibles
  // para quien inicie sesion despues en el mismo navegador.
  favorites.clear()
