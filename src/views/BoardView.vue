...
// Cantidad de publicaciones por pagina. Se llama pageSize porque
// ese es el nombre que declara la interfaz Paginated<T> del proyecto
// y el que acepta la capa de servicios.
const pageSize = 12
...
<template>
  <section>
    ...
    <template v-else>
      ...
      <!-- BasePagination declara su prop como 'limit'. La traduccion
           ocurre aca, en un solo punto, y no dentro del componente. -->
      <BasePagination
        :page="filtros.page"
        :total="total"
        :limit="pageSize"
